        ...
        {isSent ? (
          <div className="bg-white border border-emerald-100 rounded-3xl p-6 sm:p-8 text-center space-y-4 shadow-xs animate-fadeIn">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full bg-[#003366] hover:bg-[#002244] text-white font-bold text-xs py-3 px-4 rounded-[24px] shadow-xs transition-all uppercase tracking-wider cursor-pointer"
              >
                Voltar ao Suporte
              </button>
            </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white border border-slate-100 rounded-3xl p-5 shadow-xs space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-3 gap-1 bg-slate-100 p-1 rounded-xl text-[10px] font-bold">
                <button
                  ...
                  className={`py-1.5 px-1 rounded-[24px] transition-all text-center ${
                    tipo === 'melhoria' 
            ...
            <button
              type="submit"
              disabled={isSending}
              className="w-full bg-[#003366] hover:bg-[#002244] text-white font-extrabold text-xs py-3 px-4 rounded-[24px] flex items-center justify-center gap-1.5 shadow-md hover:shadow-lg transition-all active:scale-[0.99] uppercase tracking-wider mt-2 disabled:opacity-75 disabled:cursor-not-allowed cursor-pointer"
            >
              {isSending ? (
                <>
