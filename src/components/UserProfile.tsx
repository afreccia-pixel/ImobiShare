      ...
      <div className="p-4 max-w-xl mx-auto space-y-5">
            ...
            <form onSubmit={handleSaveProfile} className="space-y-3 pt-1">
              ...
              <div className="flex gap-2 pt-2">
                <button
                  type="button"
                  onClick={() => setIsEditing(false)}
                  className="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-bold py-2.5 rounded-[24px] transition-all cursor-pointer"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="flex-1 bg-[#003366] hover:bg-[#002244] text-white text-xs font-bold py-2.5 rounded-[24px] flex items-center justify-center gap-1.5 shadow-xs transition-all cursor-pointer"
                >
                  <Save size={14} />
        ...
        <div className="bg-white border border-slate-100 rounded-xl p-4 shadow-xs space-y-4" id="grupo-parceiros-card">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-blue-50 text-[#003366] text-[10px] font-extrabold px-2 py-0.5 rounded-[24px]">
          ...
          <form onSubmit={handleAddPartner} className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-[#003366] hover:bg-[#002244] text-white px-3.5 py-2 rounded-[24px] flex items-center justify-center transition-all cursor-pointer flex-shrink-0"
              >
                <Plus size={16} />
              </button>
            </div>
